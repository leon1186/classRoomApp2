...
@RestController
@RequestMapping("/users")//aqui estamos llamando al endpoints/ all lower cases.
public class UserController {


    @Autowired
    UserService serviceUser;// todos los metodos son publicos --pero los datos y atributos son lo que quiero proteger.
    ...
    public ResponseEntity<?> save(@RequestBody User dataSentByClient){
        try{
            ...
            return ResponseEntity
                    ...
                    .body(this.serviceUser.saveUser (dataSentByClient));//como es estatico no necesito llamar al objeto.
