...
@RestController
@RequestMapping("/registrations")//aqui estamos llamando al endpoints/ all lower cases.
public class RegistrationController {



    @Autowired
    RegistrationService serviceRegistration;// todos los metodos son publicos --pero los datos y atributos son lo que quiero proteger.
    ...
    public ResponseEntity<?> save(@RequestBody Registration dataSentByClient){
        try{
            ...
            return ResponseEntity
                    ...
                    .body(this.serviceRegistration.saveRegistration (dataSentByClient));//como es estatico no necesito llamar al objeto.
